...
class Vector3 {
   ...
   */
  magnitude() {
    const xSquared = this.elements[0] ** 2;
    const ySquared = this.elements[1] ** 2;
    const zSquared = this.elements[2] ** 2;

    let m = Math.sqrt(xSquared + ySquared + zSquared);
    return m;
  }
...
class Matrix4 {
  ...
  dropShadowDirectionally = function (
    ...
    return this.dropShadow([normX, normY, normZ, -a], [
      lightX,
      lightY,
      lightZ,
      0,
